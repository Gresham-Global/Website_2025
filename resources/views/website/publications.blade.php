  ...
  <section class="customSection my-5">
    ...
    <div class="row g-4 publication-container" id="publicationContainer">
      ...
      <div class="mt-1 d-flex justify-content-between align-items-center w-100">
        <a href="{{ route('publications.show', $publication->slug) }}" target="_blank" class="readmoreBtn">Read
        More</a>
      ...
      @endif
        ...
        data-url="{{ route('publications.show', $publication->slug) }}" data-title="{{ $publication->title }}">
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    const cards = document.querySelectorAll('#publicationscrads .publication-card'); // Assuming .card is the class for each card
