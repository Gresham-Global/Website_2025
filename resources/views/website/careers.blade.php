  ...
  <div class="careerbanner_container">
    <div class="careerbanner_textWrapper">
      ...
      <p class="careerbanner_description mt-2">
        ...
        universities seeking to expand their footprint. We offer tailored research and assessment solutions designed
  ...
  <div class="customContainer careerCon">
    <div class="whyWorkSection">
      <div class="cardContainer1">
        ...
        <div class="card">
          <div class="icon">
            <img src="{{ asset('website/assets/images/professional-devlopment.png') }}" alt="Development Icon" />
          </div>
          <h3>Professional Development</h3>
          <p>
            Our learning and development programs are designed to help you acquire new skills, grow professionally, and
        ...
        <div class="card">
          ...
          <p>
            We understand the importance of balance and offer flexible work arrangements to help you thrive both
        ...
        <div class="card">
          ...
          <p>
            We value hard work and celebrate achievements with competitive compensation, bonuses, and employee
      ...
      <div class="flex-fill ValueBox">
        ...
        <div class="flip-card1">
          ...
          <div class="back-card1">
            ...
            <p>We are committed to delivering the highest standards in our work, continuously striving for improvement
              and innovation</p>
          </div>
        </div>
      ...
      <div class="flex-fill ValueBox">
        ...
        <div class="flip-card1">
          ...
          <div class="back-card1">
            ...
            <p>Integrity is non-negotiable—we follow all regulations and best practices to create a secure and
      ...
      <div class="flex-fill ValueBox">
        ...
        <div class="flip-card1">
          ...
          <div class="back-card1">
            ...
            <p>Your development matters. We support continuous learning and offer opportunities to grow with us
            </p>
          </div>
        </div>
      ...
      <div class="flex-fill ValueBox">
        ...
        <div class="flip-card1">
          ...
          <div class="back-card1">
            ...
            <p>We act with honesty and transparency in all that we do, ensuring trust and respect across every
              interaction</p>
          </div>
        </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-md-6 col-lg-4 p-2 gr-4">
        <div class="opening-card p-4">
          ...
          <p class="opencard_txt"><strong class="stbgtxt">Job Description:</strong> {!!$career['short_description']!!}</p>
  ...
  <div class="customContainer">
    <div class="row d-flex align-items-center justify-content-center romdcol">
      ...
      <div class="col-md-6 col-lg-5">
        ...
        <p class="lead1">
          Explore our current openings and discover how you can contribute to Gresham Global <br>Together, let’s build
          a brighter future.
        </p>
