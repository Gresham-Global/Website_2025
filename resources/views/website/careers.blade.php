...
@php
use App\Models\Life;
$life = $life ?? Life::where('status', 1)->orderBy('order', 'asc')->get();
@endphp
<style>
    .life-slider {
        /* display: flex;
        ...
        <div class="whyWorkSection">
            <div class="cardContainer1">
                ...
                <div class="whyWorkHeading d-none d-md-block">
                    <h2 style="font-weight: 700; ">Why Work<br>with Us?</h2>
                </div>

                <div class="whyWorkHeading d-block d-md-none py-3">
                    <h2 style="font-weight: 700; ">Why Work with Us?</h2>
                </div>
...
<section id="latest-news" class="customSection mt-8 mb-6">
    <div class="customContainer">
        ...
        <div class="d-flex justify-content-center align-items-center mb-4">
            <h2 class="fw-bold">Life at Gresham Global</h2>
        </div>
        <hr>
        <div class="life-slider">
            @foreach($life as $item)
            <div class="slide-item">
                <img src="{{ asset($item->thumbnail_image) }}" class="img-fluid rounded" alt="{{ $item->title }}">
            </div>
            @endforeach
