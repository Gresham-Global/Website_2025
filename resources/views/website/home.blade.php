    ...
    <section class="sec5">
        <div class="custom-container">
            <div class="row">
                ...
                <img src="{{ asset('website/assets/images/Group 1000004157.png') }}"
                    class="w-100 d-none d-sm-none d-md-block d-lg-block" />
                <img src="{{ asset('website/assets/images/Group 1000004057.svg') }}" class="w-100 d-md-none d-lg-none" />
            </div>
        </div>
    </section>
    <!-- sec 5 ends -->
                    ...
                    @foreach ($media_for_slider as $media)
                        <div>
                            <a href="{{ $media->media_link }}" target="_blank" class="mediaText imgRadius">
                                <img src="{{ asset($media->thumbnail_image) }}" class="articalThamble" />
                            </a>
                            <div class="mediaBox">
                                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-12 mediaboxB">
                                    ...
                                    <p class="news-card-text flex-grow-1 mt-2">
                                        {{ Str::limit($news_and_blog->short_description, 50, '...') }}</p>
                                </div>
