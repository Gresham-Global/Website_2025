<section class="new-sec-6">
    <div class="row align-items-center">
        ...
        <div class="col-lg-4 d-none d-lg-block">
            <div style="overflow: hidden; height: 826px;">
                <img src="{{ asset($image ?? 'website/assets/images/our-values.png') }}"
            ...
            <div class="row ">
                ...
                <div class="col-12 col-md-6 d-flex flex-column" style="padding: 10px;">
                    <div class="d-flex align-items-center mb-4" style="gap: 15px;">
                        ...
                        <h5 class="fw-bold mb-0">{{ strtoupper($value['title']) }}</h5>
                    </div>
