            ...
            <div class="aboutInstitues-form-container">
                <div class="coursesInstitues-topContainer">
                    ...
                    <div class="item-alignment-right">
                        <a href="{{ url('admin/master/course/'.$course['id'].'/faq') }}"
                            class="btn bg-primary btn-width text-white">Course FAQ's</a>
                    </div>
                </div>
                <form name="add_course" action="{{ url('admin/master/course/'.$course['id'].'/edit') }}" method="post"
                    id="add_course" enctype="multipart/form-data">
                    @csrf
                    ...
                    <input type="hidden" id="course_level_id" name="course_level_id" value="{{$course['id']}}">
                        ...
                        <div class="form-group form-group-box w-48">
                            ...
                            <div class="input-group">
                                <input type="text" id="name_bn" name="name_bn" class="form-control"
                                    value="{{ $course['courseNameBn'] ?? '' }}" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-box w-48">
                            ...
                            <div class="input-group">
                                <input type="text" id="short_name" name="short_name" class="form-control"
                                    value="{{ $course['courseShortName'] ?? '' }}" required>
                            </div>
                        </div>
                        <div class="form-group form-group-box w-48">
                            ...
                            <div class="input-group">
                                <input type="text" id="short_name_bn" name="short_name_bn" class="form-control"
                                    value="{{ $course['courseShortNameBn'] ?? '' }}" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-box w-48">
                            ...
                            <div class="input-group">
                                <select class="form-control" name="discipline_id" id="discipline_id"
                                    ...
                                    @if(isset($disciplineData) && !empty($disciplineData))
                                    @foreach($disciplineData as $discipline)
                                    <option value="{{ $discipline['id'] }}"
                                        {{ $discipline['id'] == $course['courseDesciplineId'] ? 'selected' : '' }}>
                        ...
                        <div class="form-group form-group-box w-48">
                            ...
                            <div class="input-group">
                                <select class="form-control" name="program_level" id="program_level"
                                    ...
                                    <option value="1" {{ $course['courseProgramLevel'] == 1 ? 'selected' : '' }}>Ph.D
                                    </option>
                                    <option value="2" {{ $course['courseProgramLevel'] == 2 ? 'selected' : '' }}>Post
                                        Graduate</option>
                                    <option value="3" {{ $course['courseProgramLevel'] == 3 ? 'selected' : '' }}>Under
                                        Graduate</option>
                                    <option value="4" {{ $course['courseProgramLevel'] == 4 ? 'selected' : '' }}>Diploma
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-group-box w-48">
                            ...
                            <div class="input-group">
                                <input type="text" id="eligibility" name="eligibility" class="form-control"
                                    value="{{ $course['courseEligibility'] ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group form-group-box w-48">
                            ...
                            <div class="input-group">
                                <input type="text" id="eligibility_bn" name="eligibility_bn" class="form-control"
                                    value="{{ $course['courseEligibilityBn'] ?? '' }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-box w-48">
                            ...
                            <div class="input-group">
                                <textarea class="form-control" rows="2" placeholder="Enter Description" id="description"
                                    name="description">{{ $course['courseDescription'] ?? '' }}</textarea>
                            </div>
                        </div>

                        <div class="form-group form-group-box w-48">
                            <label for="description_bn" class="fullName">Description</label>
                            <div class="input-group">
                                <textarea class="form-control" rows="2" placeholder="Enter Description"
                                    id="description_bn"
                                    name="description_bn">{{ $course['courseDescriptionBn'] ?? '' }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-flex-box p-0 mt-3">
                            ...
                            <div class="input-group">
                                <div class="form-check m-3">
                                    <input class="form-check-input" type="radio" id="show_in_menu" name="show_in_menu"
                                        value="1"
                                        {{(old('show_in_menu')=='1' || $course['showInMenu']=='1')?'checked':'' }}>
                                    ...
                                    <input class="form-check-input" type="radio" id="show_in_menu1" name="show_in_menu"
                                        value="0"
                                        {{(old('show_in_menu')=='0'|| $course['showInMenu']=='0')?'checked':'' }}>
                    ...
                    <div class="form-flex-box p-0 m-0">
                        ...
                        <div class="form-flex-box p-0 mt-3">
                            <div class="form-group form-group-box w-48">
                                <label for="banner_image_url" class="fullName">Banner Image Uploaded File
                                    Preview</label>
                                <div class="input-group" style="height: 100px">
                                    @if ($course['bannerImagePath']==NULL)
                                    <strong class="mt-4 pl-2"> The banner image has not been updated. Please upload
                                        it.</strong>
                                    @else
                                    <a href="{{ $course['bannerImagePath'] }}" target="blank">
                                        <img src="{{ $course['bannerImagePath'] }}" alt="Icon"
                                            style="width: 100%; height: 100px;">
                                    </a>
                                    @endif
                                </div>
                            </div>
                            <input type="hidden" id="banner_image_url_original" name="banner_image_url_original"
                                class="form-control" value="{{$course['bannerImage']}}">
                        </div>
                    ...
                    <div class="form-flex-box p-0 mt-3">
                        ...
                        <div
                            class="form-group {{ $errors->has('meta_description') ? 'has-error' : '' }} w-48 form-group-box">
                            ...
                            <div class="input-group">
                                <input type="text" id="meta_description" name="meta_description" class="form-control"
                                    value="{{ old('meta_description') ? old('meta_description') : $course['meta_description'] }}">
                    ...
                    <div class="form-flex-box p-0 mt-0">
                        <div
                            class="form-group {{ $errors->has('meta_keyword') ? 'has-error' : '' }} w-48 form-group-box">
                            ...
                            <div class="input-group">
                                <input type="text" id="meta_keyword" name="meta_keyword" class="form-control"
                                    value="{{ old('meta_keyword') ? old('meta_keyword') : $course['meta_keyword'] }}">
