            ...
            <div class="courses-institues-container">
                <div class="coursesInstitues-topContainer">
                    ...
                    <div class="item-alignment-right">
                        <a href="{{route('admin.master.placement-companies.create')}}"
                            class="btn btn-block bg-primary btn-width text-white">Add placement companies</a>
                    </div>
                </div>

                <!-- ==========Documents============= -->
                <div class="accountsetting-form-footer-container table-responsive">
                    <table class="table table-bordered mt-1 w-100" id="placement-companies-table">
