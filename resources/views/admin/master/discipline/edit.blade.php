    ...
    <div class="boardView-container">
        <div class="about-institues-section">
            <div class="aboutInstitues-form-container">
                <form name="edit_discipline"
                    action="{{ url('admin/master/discipline/' . $discipline['id'] . '/edit') }}" method="post"
                    id="edit_discipline" enctype="multipart/form-data">
                    @csrf
                    ...
                    @endif
                    <br>
                    <input type="hidden" id="course_level_id" name="course_level_id" value="{{$discipline['id']}}">
                        ...
                        <div class="form-group form-group-box w-48">
                            ...
                            <div class="input-group">
                                <input type="text" id="name" name="name" class="form-control"
                                    value="{{ $discipline['disciplineName'] ?? '' }}" required>
                            </div>
                        </div>
                        <div class="form-group form-group-box w-48">
                            ...
                            <div class="input-group">
                                <input type="text" id="name_bn" name="name_bn" class="form-control"
                                    value="{{ $discipline['disciplineNameBn'] ?? '' }}" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-box w-48">
                            ...
                            <div class="input-group">
                                <textarea class="form-control" rows="2" placeholder="Enter Description" id="description"
                                    name="description">{{ $discipline['disciplineDescription'] }}</textarea>
                            </div>
                        </div>
                        <div class="form-group form-group-box w-48">
                            ...
                            <div class="input-group">
                                <textarea class="form-control" rows="2" placeholder="Enter Description"
                                    id="description_bn"
                                    name="description_bn">{{ $discipline['disciplineDescriptionBn'] ?? '' }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-box w-48">
                            ...
                            <div class="input-group">
                                <input type="file" id="discipline_icon_url" name="discipline_icon_url"
                                    class="form-control" accept=".svg,.webp">
                            </div>
                        </div>
                        <div class="form-group form-group-box w-48">
                            <label for="discipline_icon_url" class="fullName">Discipline Icon Uploaded File
                                Preview</label><br>
                            <div >
                                <a href="{{ $discipline['disciplineIconUrl'] }}" target="_blank">
                                    <img src="{{ $discipline['disciplineIconUrl'] }}" alt="Icon"
                    ...
                    <div class="form-flex-box p-0 mt-1">
                        <div class="form-group form-group-box w-48">
                            ...
                            <div class="input-group">
                                <input type="text" id="schema_description" name="schema_description"
                                    class="form-control"
                                    value="{{ old('schema_description') ?? $discipline['schemaDescription'] }}">
                            </div>
                        </div>
                        <div class="form-group {{ $errors->has('meta_title') ? 'has-error' : '' }} w-48 form-group-box">
                            ...
                            <input type="text" id="meta_title" name="meta_title" class="form-control"
                                value="{{ old('meta_title') ? old('meta_title') : $discipline['meta_title'] }}">
                    ...
                    <div class="form-flex-box p-0 mt-3">
                        ...
                        <div class="form-group {{ $errors->has('meta_description') ? 'has-error' : '' }} w-48 form-group-box">
                            ...
                            <input type="text" id="meta_description" name="meta_description" class="form-control"
                                value="{{ old('meta_description') ? old('meta_description') : $discipline['meta_description'] }}">
                        ...
                        <div class="form-group {{ $errors->has('meta_keyword') ? 'has-error' : '' }} w-48 form-group-box">
                            ...
                            <div class="input-group">
                                <input type="text" id="meta_keyword" name="meta_keyword" class="form-control"
                                    value="{{ old('meta_keyword') ? old('meta_keyword') : $discipline['meta_keyword'] }}">
                    ...
                    <input type="hidden" id="discipline_icon_url_original" name="discipline_icon_url_original"
                        class="form-control" value="{{$discipline['disciplineIconUrlOriginal']}}">
