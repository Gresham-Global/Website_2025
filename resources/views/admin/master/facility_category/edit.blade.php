    ...
    <div class="boardView-container">
        <div class="about-institues-section">
            <div class="aboutInstitues-form-container">
                <form name="add_discipline"
                    action="{{ url('admin/master/facility-category/' . $facilityCategory['id'] . '/edit') }}"
                    method="post" id="add_discipline">
                    @csrf
                    @if(session('status'))
                        ...
                        <div class="form-group form-group-box w-48">
                            ...
                            <div class="input-group">
                                <input type="text" id="name" name="name" class="form-control"
                                    value="{{$facilityCategory['facilityCategoryName']}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-group-box w-48">
                            ...
                            <div class="input-group">
                                <input type="text" id="name_bn" name="name_bn" class="form-control"
                                    value="{{$facilityCategory['facilityCategoryNameBn']}}" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-box w-48">
                            ...
                            <div class="input-group">
                                <textarea class="form-control" rows="2" placeholder="Enter Description" id="description"
                                    name="description">{{$facilityCategory['facilityCategoryDescription']}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-group-box w-48">
                            ...
                            <div class="input-group">
                                <textarea class="form-control" rows="2" placeholder="Enter Description"
                                    id="description_bn"
                                    name="description_bn">{{$facilityCategory['facilityCategoryDescriptionBn']}}</textarea>
                            </div>
                        </div>
                    </div>
