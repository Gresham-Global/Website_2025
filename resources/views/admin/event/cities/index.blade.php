            ...
            <div class="courses-institues-container">
                <div class="coursesInstitues-topContainer">
                    ...
                    <div class="item-alignment-right">
                        <a href="{{route('admin.event.cities.create')}}" 
                            class="btn btn-block bg-primary btn-width text-white">Add Events Cities </a>
                    </div>
                </div>

                <!-- ==========Documents============= -->
                <div class="accountsetting-form-footer-container table-responsive">
                    <table class="table table-bordered mt-1 w-100" id="cities-table">
