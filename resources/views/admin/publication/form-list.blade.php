            ...
            <div class="courses-institues-container">
                <div class="coursesInstitues-topContainer">
                    <div class="coursesInstitues-topContainer-leftbox">
                        ...
                        <button id="downloadBtn" class="ml-2 btn bg-primary btn-width text-white">Dowload Publication Form List Data</button>
                ...
                <div class="accountsetting-form-footer-container table-responsive">
                    <table class="table table-bordered mt-1 w-100" id="publication-form-list-table">
                        <thead style="background-color: #f5ece6">
                            <tr>
                                ...
                                <th>Publication download Count</th>
                                <th>Date</th>
                            </tr>
                        </thead>
